...
namespace Aero
{
    ...
    public abstract class ParticleSystem// : DrawableGameComponent
    {
        ...
        public void LoadContent()
        {
            ...
            // load the texture....
            //texture = AeroGame.ContentManager.Load<Texture2D>(textureFilename);
            if (AeroGame.lagTest)
                texture = AeroGame.LoadTextureStream(textureFilename);
            else
                texture = AeroGame.ContentManager.Load<Texture2D>("Textures\\" + textureFilename);
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles =
                AeroGame.Random.Next(minNumParticles, maxNumParticles);
        ...
        {
            float angle = AeroGame.RandomBetween(0, MathHelper.TwoPi);
        ...
        public virtual void Update(TimeSpan elapsedTime)
        {
            ...
            foreach (Particle p in particles)
            {
                ...
                if (p.Active)
                {
                    ...
                    p.Update((float)elapsedTime.TotalSeconds);
        ...
        public void Draw()
        {
            ...
            AeroGame.SpriteBatch.Begin(SpriteSortMode.Immediate, blendState);
            ...
            foreach (Particle p in particles)
            {
                ...
                AeroGame.SpriteBatch.Draw(texture, p.Position, null, particleColor,
